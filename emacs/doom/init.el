...
(setq
  ...
  ;; Keep C-u as universal prefix argument. (For reference; doesn't help with insert
  ;; mode including minibuffer, so it's best to just remap universal argument to M-u.)
