...
conky_background_alpha = 0.60
conky_stroke_color     = 0xffffff
conky_stroke_alpha     = 1.0
...
settings_table = {
    ...
    {
        name='upspeedf',								--needs to be done separately for both interfaces
        arg='eth0',
        max=5000,
        bg_colour=ring_background_color,
        bg_alpha=ring_background_alpha/2,
        fg_colour=ring_foreground_color,
        fg_alpha=ring_foreground_alpha,
        x=52, y=60,
        --x=20, y=122,
...
function draw_ring(cr,t,pt)
    ...
    --xc and yc is where the drawing coordinates are set
...
function conky_ring_stats()
    ...
    if update_num>5 then
        ...
        cairo_rectangle (cr, 3, 0, conky_window.width-4, conky_window.height-3)
        cairo_set_source_rgba(cr, rgb_to_r_g_b(conky_background_color, conky_background_alpha))
        cairo_fill_preserve(cr)
        cairo_set_source_rgba(cr, rgb_to_r_g_b(conky_stroke_color, conky_stroke_alpha))
        cairo_stroke(cr)
